  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.render = function() {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        operation = _ref4[_i];
        //filter out admin operations if authenticated user isn't admin
        //isAdmin global variable defined in main.scala.html
        if(operation.nickname != "admin" || isAdmin){
            this.addOperation(operation);
        }else{
            console.log("hiding operation " + operation)
        }
      }
      return this;
    };
